...
begin   symbol := s;  mass := m;   end;
function Atom.getSym : sym;
begin   getSym := symbol;   end;
function Atom.getMass : real;
begin   getMass := mass;   end;
procedure Atom.print;
begin   writeln(symbol, ': ', mass);   end;
// end::implementation[]
// tag::testing[]
Var
  Fe, Cl : Atom;
